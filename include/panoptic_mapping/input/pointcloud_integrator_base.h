#ifndef PANOPTIC_MAPPING_INPUT_POINTCLOUD_INTEGRATOR_BASE_H_
#define PANOPTIC_MAPPING_INPUT_POINTCLOUD_INTEGRATOR_BASE_H_
...
#endif //PANOPTIC_MAPPING_INPUT_POINTCLOUD_INTEGRATOR_BASE_H_
