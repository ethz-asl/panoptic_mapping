...
ProjectiveMutliTSDFIntegrator::Config ProjectiveMutliTSDFIntegrator::getConfigFromRos(const ros::NodeHandle &node_handle){
  ...
  node_handle.param("vertical_fov_deg", config.vertical_fov_deg, config.vertical_fov_deg);
  node_handle.param("min_ray_length_m", config.min_ray_length_m, config.min_ray_length_m);
  node_handle.param("max_ray_length_m", config.max_ray_length_m, config.max_ray_length_m);
  node_handle.param("voxel_carving_enabled", config.voxel_carving_enabled, config.voxel_carving_enabled);
  return config;
}
